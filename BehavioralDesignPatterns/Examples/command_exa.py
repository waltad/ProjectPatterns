"""Command
Celem behawioralnego wzorca Command jest rozdzielenie obiektów, które wysyłają żądania, od obiektów, które przyjmują ich
 rezultat. Robi to poprzez wprowadzenie obiektu reprezentującego komendę, która taki proces wykonuje. Opcjonalnie
  komenda może mieć również możliwość cofnięcia rezultatu takiego procesu.

Dzięki opakowaniu wykonania procesu w osobny obiekt zachowujemy zasady SOLID, usuwając potencjalne silne powiązanie
 między wysyłającym a przyjmującym wynik żądania.

Konstrukcja i przykład
Głównym elementem, jaki musimy stworzyć, jest wspólny obiekt reprezentujący wykonanie procesu. Opcjonalnie może istnieć
 możliwość cofnięcia wykonania komendy.

Obiekty potrzebne do wykonania komendy, najczęściej przychodzą w konstruktorze implementacji.

Przykład poniżej wykorzystuje interfejs Command, wraz z dwoma implementacjami: ChangeFileNameCommand i
 RemoveEmptyLinesCommand. Istnieje możliwość cofnięcia wywołania komendy ChangeFileNameCommand za pomocą metody cancel.
 """
